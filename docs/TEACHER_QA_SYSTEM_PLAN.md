...
*   **목표:** 활동 보상 시스템 및 리더보드 구축
*   [Backend] `increment()`를 활용한 원자적 보상 로직 (답변 채택: +20, 질문 해결: +5)
*   [Backend] 선생님 전용 **'베스트 답변 인증'** 보너스 시스템 (+10)
*   [Admin] 우주 테마 칭호 시스템 (뉴턴, 아인슈타인 등) 적용
*   [Client] 실시간 Hall of Fame (도움 횟수 기반 Top 10) 리더보드
*   [UI] 보상 획득 시 '광석 버스트' 시각 효과 및 해결률 그래프 제공
*   **상세 전략:** [GAMIFICATION_STRATEGY.md](./GAMIFICATION_STRATEGY.md) 참조
