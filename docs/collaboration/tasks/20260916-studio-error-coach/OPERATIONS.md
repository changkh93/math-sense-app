> 2026-09-16 후속 변경: 코드 구조 전송 v2 구현·운영 준비 사항은 [새 운영 기록](../20260916-studio-private-coach/OPERATIONS.md)을 참고하세요. 아래는 v1 배포 당시 기록이며, ZDR 승인이나 학생용 활성화를 뜻하지 않습니다.

# 코드 스튜디오 오류 도우미 운영 준비

이 문서는 구현된 기능의 연결 절차다. 2026-09-16 새 프로젝트와 Secret 4번으로 합성 데이터 Luna 호출(HTTP 200) 및 동일 요청 캐시를 확인했다. 2026-09-16 d49240c5의 Hosting 및 studioErrorCoach 함수 배포를 완료했다. 학생용 활성화와 운영 설정 쓰기는 아직 수행하지 않았다. 상세 이력은 STATE.md를 참조한다.
