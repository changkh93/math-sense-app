      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem' }}>
            ...
            <li><strong>크루 게스트 체험 정보:</strong> 익명 인증 식별자와 초대받은 크루 정보. 게스트에게 실명, 학교명, 연락처 또는 이메일을 요구하지 않습니다.</li>
            <li><strong>부정 이용 방지 정보:</strong> 원문을 저장하지 않고 서버 비밀키로 변환한 접속 IP·브라우저 설치 식별자 해시, 게스트 활동 횟수와 위험 신호. 크루 이벤트의 중복 참여 탐지와 운영자 검토에만 사용합니다.</li>
          </ul>
        </section>
