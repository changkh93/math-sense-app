    ...
    snap.docs.forEach(userDoc => {
      ...
      profileMap.set(userDoc.id, {
        ...
        crewGrowthEvent2026RewardedAtMs: Number(
          ...
          data.crewGrowthReward_t10_AtMs ||
        ...
        crewGrowthEvent2026CampaignId: data.crewGrowthEvent2026CampaignId || ((data.crewGrowthReward_t20_AtMs || data.crewGrowthReward_t10_AtMs) ? 'crew_growth_v2_2026' : (data.lastCrewGrowthRewardAt ? 'crew_growth_20_2026' : '')),
      });
    });
  }
