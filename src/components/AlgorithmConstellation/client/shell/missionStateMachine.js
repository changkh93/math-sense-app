...
const ALLOWED_CLIENT_TRANSITIONS = {
  ...
  [MISSION_STATES.OBSERVE]: [MISSION_STATES.EXPLORE, MISSION_STATES.CODE],
  [MISSION_STATES.EXPLORE]: [MISSION_STATES.OBSERVE, MISSION_STATES.CODE],
  [MISSION_STATES.CODE]: [MISSION_STATES.RUN_SUCCESS, MISSION_STATES.OBSERVE, MISSION_STATES.EXPLORE],
  [MISSION_STATES.RUN_SUCCESS]: [MISSION_STATES.UNDERSTANDING_CHECK, MISSION_STATES.CODE, MISSION_STATES.OBSERVE, MISSION_STATES.EXPLORE],
  [MISSION_STATES.UNDERSTANDING_CHECK]: [MISSION_STATES.TRANSFER_CHALLENGE, MISSION_STATES.CODE, MISSION_STATES.OBSERVE, MISSION_STATES.EXPLORE],
  [MISSION_STATES.TRANSFER_CHALLENGE]: [MISSION_STATES.COMPLETE, MISSION_STATES.CODE, MISSION_STATES.OBSERVE, MISSION_STATES.EXPLORE],
  [MISSION_STATES.COMPLETE]: [MISSION_STATES.BRIEFING, MISSION_STATES.CODE, MISSION_STATES.OBSERVE],
}
