      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        {sections.map(({ key, title }) => {
          const regionBadges = challengeBadges.filter(b => {
            ...
            if (key === 'reading') return b.category === 'reading';
            if (key === 'general') return !b.clusterId && b.category !== 'region_master' && b.category !== 'agora' && b.category !== 'crew' && b.category !== 'reading';
