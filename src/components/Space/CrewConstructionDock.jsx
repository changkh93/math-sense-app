...
import { Check, ChevronRight, CircleDollarSign, Gem, Hammer, LockKeyhole, RadioTower, Sparkles } from 'lucide-react'
    ...
    <section className="crew-construction-dock">
      <div className="crew-construction-dock__head">
        <div>
          ...
          <p>리더가 시설을 선택하면 모든 멤버가 원하는 만큼 광석을 지원합니다. 기부 순위는 만들지 않습니다.</p>
        </div>
