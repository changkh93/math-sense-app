  ...
  return (
    <main className="battle-hub">
      ...
      <header className="battle-hub__hero">
        ...
        <div className={`battle-ship-dock ${getActiveShipFamily(userData) === 'pathfinder' ? 'is-pathfinder' : ''}`}>
          ...
          <div>
            ...
            <small>선택한 부품 그대로 배틀 대기룸에 입장합니다</small>
          </div>
        </div>
      </header>
      ...
      <section className="battle-deck">
        ...
        <div className="battle-guest-note"><b>FAIR PLAY</b> 현재 학습 중인 과정과 리전에서만 참여할 수 있습니다. 하루 배틀 광석은 최대 500개입니다. 같은 유닛·누적 범위의 보상은 하루 1회차 100%, 2회차 50%, 3회차 20%로 줄며 이후에는 연습 경기로만 진행됩니다. 같은 상대와의 대결도 하루 3회까지만 보상·공식 전적에 반영됩니다. AI 사용 및 부정행위가 적발되면 퀴즈 배틀에서 영구 퇴출될 수 있습니다.</div>
