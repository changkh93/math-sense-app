          ...
          <div className="crew-growth-status__rules font-tech">
            ...
            {showGrowthRules && (
              <div className="crew-growth-rules-body" style={{ marginTop: '0.65rem', display: 'grid', gap: '0.35rem' }}>
                ...
                <span>10명·20명·40명 각각 도달 순간의 명단을 48시간 검증합니다. 새 회원은 고정 명단의 이탈자를 대신할 수 없습니다.</span>
                <span>정회원은 최초 크루에 고정되고 48시간 후 집계됩니다. 탈퇴하면 같은 크루 재가입·다른 크루 이동 후에도 이번 캠페인의 인원과 보상에서 제외됩니다.</span>
                <span>10명 달성 시 +500광석, 20명 달성 시 +1,000광석, 40명 달성 시 +4,000광석입니다. 각 보상 이후 합류한 회원에게 해당 광석을 소급 지급하지 않습니다.</span>
