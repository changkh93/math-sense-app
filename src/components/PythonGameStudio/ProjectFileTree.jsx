...
import { Notebook, ChevronDown, ChevronRight, Folder, FolderOpen, FileCode2, Image, Music, Type } from 'lucide-react'
const icons = { python: FileCode2, notebook: Notebook, csv: FileCode2, image: Image, audio: Music, font: Type }
