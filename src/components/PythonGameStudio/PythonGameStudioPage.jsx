...
export default function PythonGameStudioPage({ onBack }) {
  ...
  if (!allowed) return <div className="space-bg" style={{ padding: 40, minHeight: '100vh' }}><h2>메타센스 코드 스튜디오</h2><p>파이썬 수강 계정으로 로그인해 주세요.</p><button onClick={back}>돌아가기</button></div>
