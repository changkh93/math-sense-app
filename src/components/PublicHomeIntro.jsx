...
export default function PublicHomeIntro({ onLogin }) {
  ...
  return <div className="ms-home">
    ...
    <header className="ms-header">
      ...
      <nav className="ms-navigation" aria-label="과정 안내"><a href="/math/">초등수학</a><a href="/python">파이썬</a><a href="/math/books/">수학감각 교재</a></nav>
    ...
    <main id="home-main">
      ...
      <section id="home-courses" className="ms-section ms-shell">
        ...
        <div className="ms-course-grid">
          <article className="ms-course ms-course-math"><div className="ms-course-top"><span>01 · MATHEMATICS</span><span className="ms-course-symbol" aria-hidden="true">× ÷</span></div><h3>초등수학</h3><p>공식을 외우기 전에,<br /><strong>그림 속에서 이유를 발견해요.</strong></p><div className="ms-course-topics">곱셈 · 나눗셈 · 분수 · 소수 · 비와 비례식</div><ul><li>수학감각 교재와 영상으로 개념 이해</li><li>인터랙티브 도구·퀴즈·워크북으로 확인</li><li>학습 기록과 일대일 성장 면담</li></ul><a className="ms-course-link" href="/math/">초등수학 과정 살펴보기 <Arrow /></a></article>
        ...
        <article className="ms-reading"><div><span className="ms-eyebrow">03 · READING & THINKING</span><h3>고전읽기, 한 문장에서 시작하는 질문.</h3><p>책을 읽고 자기 생각을 말하며, 다른 관점을 만납니다.</p></div><a href="/trial" className="ms-text-link">고전읽기 과정 안내 <Arrow /></a></article>
      </section>
