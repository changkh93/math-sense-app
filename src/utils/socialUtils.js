...
export const AGORA_ASKER_ACCEPT_COST = 10;
...
export const BASE_THEMES = [
  ...
  },
  {
    ...
    icon: '📚',
    accent: '#a78bfa',
    pageBackground: 'radial-gradient(circle at 75% 15%, rgba(167, 139, 250, 0.22), transparent 36%), radial-gradient(circle at 20% 80%, rgba(99, 102, 241, 0.14), transparent 34%), linear-gradient(135deg, #100b24 0%, #0f172a 52%, #1a103c 100%)',
    surface: 'rgba(18, 14, 38, 0.82)',
    description: '은은한 달빛과 고전 기하학 서재가 어우러진 탐험기지 배경입니다.',
  ...
  },
  {
    ...
    icon: '🔮',
    accent: '#2dd4bf',
    pageBackground: 'radial-gradient(circle at 20% 20%, rgba(45, 212, 191, 0.24), transparent 34%), radial-gradient(circle at 80% 75%, rgba(56, 189, 248, 0.16), transparent 36%), linear-gradient(135deg, #042022 0%, #0f172a 50%, #062e2e 100%)',
    surface: 'rgba(4, 30, 32, 0.82)',
    description: '신비로운 발광 결정과 수학 공식 홀로그램이 반짝이는 동굴 배경입니다.',
    releasedAt: '2026-08-21',
    newUntil: '2026-09-21',
    sortOrder: 6,
  },
  {
    ...
    icon: '🌿',
    accent: '#fb923c',
    pageBackground: 'radial-gradient(circle at 80% 20%, rgba(251, 146, 60, 0.24), transparent 34%), radial-gradient(circle at 20% 75%, rgba(34, 197, 94, 0.14), transparent 32%), linear-gradient(135deg, #241006 0%, #111827 50%, #2e1508 100%)',
    surface: 'rgba(32, 18, 10, 0.82)',
    description: '주황빛 화성 사막 속 웅장한 투명 유리 돔 온실과 생태 정원 배경입니다.',
    releasedAt: '2026-08-21',
    newUntil: '2026-09-21',
    sortOrder: 7,
  },
  {
    ...
    icon: '⚡',
    accent: '#818cf8',
    pageBackground: 'radial-gradient(circle at 25% 15%, rgba(129, 140, 248, 0.25), transparent 32%), radial-gradient(circle at 75% 85%, rgba(236, 72, 153, 0.14), transparent 34%), linear-gradient(135deg, #090e2a 0%, #0f172a 52%, #14183e 100%)',
    surface: 'rgba(12, 18, 44, 0.84)',
    description: '첨단 사이버 네온 그리드와 양자 연산 수식 터미널 배경입니다.',
    releasedAt: '2026-08-21',
    newUntil: '2026-09-21',
    sortOrder: 8,
  },
  {
    ...
    icon: '⛺',
    accent: '#38bdf8',
    pageBackground: 'radial-gradient(circle at 75% 20%, rgba(56, 189, 248, 0.24), transparent 34%), radial-gradient(circle at 25% 80%, rgba(245, 158, 11, 0.12), transparent 32%), linear-gradient(135deg, #081628 0%, #0f172a 52%, #0b223d 100%)',
    surface: 'rgba(8, 24, 42, 0.8)',
    description: '밤하늘을 가르는 유성우와 포근한 별빛 야외 캠프 배경입니다.',
    releasedAt: '2026-08-21',
    newUntil: '2026-09-21',
    sortOrder: 9,
  },
  {
    ...
    icon: '🌸',
    accent: '#e879f9',
    pageBackground: 'radial-gradient(circle at 30% 20%, rgba(232, 121, 249, 0.24), transparent 35%), radial-gradient(circle at 75% 75%, rgba(168, 85, 247, 0.18), transparent 35%), linear-gradient(135deg, #1e0928 0%, #111827 50%, #2a0b38 100%)',
    surface: 'rgba(30, 12, 38, 0.82)',
    description: '신비로운 프랙탈 기하 정원과 화려한 무한의 문양이 펼쳐지는 프리미엄 배경입니다.',
    releasedAt: '2026-08-21',
    newUntil: '2026-09-21',
    sortOrder: 10,
  },
...
export const SOCIAL_STORE_ITEMS = [
  ...
  {
    id: 'base_lunar_library',
    name: '달빛 수학 서재',
    icon: '📚',
    cost: 130,
    type: 'base',
    themeId: 'lunar_library',
    description: '공개 탐험기지에 은은한 달빛과 고전 기하학 서재 배경을 적용할 수 있습니다.',
  },
  {
    id: 'base_crystal_cavern',
    name: '수정 공식 동굴',
    icon: '🔮',
    cost: 150,
    type: 'base',
    themeId: 'crystal_cavern',
    description: '공개 탐험기지에 신비로운 발광 결정과 홀로그램 동굴 배경을 적용할 수 있습니다.',
  },
  {
    id: 'base_mars_greenhouse',
    name: '화성 생태 온실',
    icon: '🌿',
    cost: 140,
    type: 'base',
    themeId: 'mars_greenhouse',
    description: '공개 탐험기지에 화성 사막 속 거대한 투명 유리 돔 온실 배경을 적용할 수 있습니다.',
  },
  {
    id: 'base_quantum_terminal',
    name: '양자 연산 실험실',
    icon: '⚡',
    cost: 170,
    type: 'base',
    themeId: 'quantum_terminal',
    description: '공개 탐험기지에 첨단 사이버 네온 그리드와 수식 터미널 배경을 적용할 수 있습니다.',
  },
  {
    id: 'base_comet_camp',
    name: '혜성 관측 캠프',
    ...
    type: 'base',
    themeId: 'comet_camp',
    description: '공개 탐험기지에 밤하늘 유성우와 아늑한 별빛 야외 캠프 배경을 적용할 수 있습니다.',
  },
  {
    id: 'base_infinity_garden',
    name: '무한의 정원',
    icon: '🌸',
    cost: 180,
    type: 'base',
    themeId: 'infinity_garden',
    description: '공개 탐험기지에 프랙탈 기하 정원과 무한의 문양 프리미엄 배경을 적용할 수 있습니다.',
  },
  {
