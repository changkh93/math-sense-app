...
export const cyan='#83eddf'; export const pink='#ffb17d';
export const Background:React.FC<{children?:React.ReactNode}>=({children})=>{
 const f=useCurrentFrame();
 return <AbsoluteFill style={{background:'radial-gradient(ellipse at 70% 20%, #442831 0%, #171627 55%, #0b101b 100%)',color:'#f5f8ff',fontFamily:'DoHyeon',overflow:'hidden'}}>
