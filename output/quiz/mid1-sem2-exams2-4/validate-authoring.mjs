...
const ids={2:'1788876955807',3:'1788876965426',4:'1788876975928'};
...
for(const round of [2,3,4]){
  ...
  assert.equal(questions.length,25);assert.equal(manifest.questions.length,25);
  assert.equal(manifest.round,round);
  assert.equal(manifest.unitId,`reg_1781420075936_chap_1781420191007_unit_${ids[round]}`);
...
console.log(JSON.stringify({questions:75,mathExpressions:mathCount,imageCount,structuralValidation:'PASS',educationalReview:'still required by Codex'}));
