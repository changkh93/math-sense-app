...
const ids={1:'1788903283590',2:'1788903293848',3:'1788907111960',4:'1788907123074'};
...
for(const round of [1,2,3,4]){
  ...
  assert.equal(questions.length,({1:25,2:30,3:26,4:19})[round]);assert.equal(manifest.questions.length,({1:25,2:30,3:26,4:19})[round]);
...
console.log(JSON.stringify({questions:100,mathExpressions:mathCount,imageCount,structuralValidation:'PASS',educationalReview:'still required by Codex'}));
