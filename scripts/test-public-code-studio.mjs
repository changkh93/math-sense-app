...
assert(preview.includes('단계별 프로젝트 시작하기 →'))
assert(preview.includes('MetaSense Python에서 처음부터 차근차근 만들 수 있어요.'))
assert(!preview.includes('7일 무료로 시작하기'))
assert(!preview.includes("trackPython('python_cta', 'studio_trial')"))
