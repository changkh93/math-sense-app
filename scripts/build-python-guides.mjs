...
const cta = `<section class="cta"><h2>우리 아이에게 맞는 시작점을 찾아보세요.</h2><p>초4~중2 · 직접 코딩하는 학습 · 정규 월15만 원 · 기본 7일 무료체험<br>신청 후 1일 이내 연락 · 자동 결제 없음</p><a class="button" href="/python#apply">파이썬 과정·체험 안내</a></section>`;
