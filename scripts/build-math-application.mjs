...
await writeFile('dist/math-application/index.html',`<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex"><title>수학과 고전읽기 7일 무료체험 신청서</title><link rel="stylesheet" href="./application.css"><style>body{margin:0;background:#102d29}</style></head><body><div id="math-application"></div><script type="module" src="./application.js"></script></body></html>`);
